...
// test("Testing the App to see stuff and also things", () => {
//     render(<App />)
// })



test("Data is fetched when a season is selected", async () => {
    fetchShow.mockResolvedValueOnce({data: allInfo})
    ...
    // await waitFor(() => {
    //     fireEvent.click(screen.getAllByText(/season/i)[1]);
    // });
